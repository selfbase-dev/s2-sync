...
func TestExecute_Push_RemoteKey(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			...
			execute(plans, localDir, c, state, false, executeDeps{})
...
func TestExecute_DeleteLocal(t *testing.T) {
	...
	result, _ := execute(plans, localDir, c, state, false, executeDeps{})
	if result.Deleted != 1 {
...
func TestExecute_DeleteRemoteDir_DryRun(t *testing.T) {
	...
	result, _ := execute(plans, localDir, c, state, true, executeDeps{})
	if called {
